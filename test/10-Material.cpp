...
// 兼容性配置
    ...
    // ------------------------------------
    Shader customizedShader("shaders/10/shader.vs", "shaders/10/shader_caster.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        customizedShader.use();
        customizedShader.setVec3("light.direction", -0.2f, -1.0f, -0.3f);
        customizedShader.setVec3("viewPos", camera.Position);

        // light properties
        customizedShader.setVec3("light.ambient", 0.2f, 0.2f, 0.2f);
        customizedShader.setVec3("light.diffuse", 0.5f, 0.5f, 0.5f);
